...
const { buildData, t } = require("../template");
...
function matchJob(jobText, base, variant = {}, lang = "es") {
  const data = buildData(variant, lang, base);
...
function rankVariants(jobText, base, variantsMap, lang = "es") {
...
function rankAchievements(jobText, achievements, lang = "es", opts = {}) {
...
module.exports = { STOPWORDS, normalize, tokenize, extractKeywords, cvCorpus, matchJob, rankVariants, rankAchievements };
